...
export default StyleSheet.create({
  ...
  profilepicview_navigationdrawertenant: {
    height: 70,
    width: 70,
    //backgroundColor:"#ff0000",
    borderRadius: 200
  ...
  itemflat1_timelinetenant: { flexDirection: "row", marginTop: 20 },
  ...
  notificationlist_notificationtenant: { width: "100%", paddingBottom: 20 },
  ...
  // headertextstyle_unitdetailsproperty:
  // { color: "#9f9f9f"},

  // bluecontenttextstyle_unitdetailsproperty:
  // { color: bluemain, fontWeight:"500", fontSize:20},

  // contextmainview_unitdetailsproperty:
  // {flex:9, backgroundColor:"#ffff", marginTop:30},

  // addresstextstyle2_unitdetailsproperty:
  // { color: "#444444", fontSize:20},

  // contextsubview_unitdetailsproperty:
  // {marginBottom:30},
